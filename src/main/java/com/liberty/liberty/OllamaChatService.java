...
public class OllamaChatService {
    ...
    public OllamaChatService(SmoothTyper agentResponseTyper) {
        ...
        System.out.println(Arrays.toString(AVAILABLE_MODELS));
        builder = OllamaChatRequest.builder().withModel(AVAILABLE_MODELS[1]);
        requestModel = builder.withMessage(OllamaChatMessageRole.SYSTEM, String.format("""
    ...
    public OllamaChatRequest getBuilder() {
        return builder;
    }

    public void setRequestModel(OllamaChatRequest requestModel){
